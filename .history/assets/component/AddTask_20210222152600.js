...
const AddTask = ({ navigation }) => {
  ...
  const onPressHandler = () => {
    const payload = {
      ...
      t,
      taskDesc,
    };        this.props.navigation.navigate("TaskListing");
        ...
        <View style={Styles.form}>
          <ScrollView>
            ...
            <View style={Styles.Taskmain}>
              <View style={Styles.Taskinside}>
                <View style={Styles.buttondate}>
                  <Button style={Styles.buttoncolor} onPress={showTimepicker} title="Select Time" backgroundColor="red" />
                </View>
              </View>
              <TextInput
                style={Styles.input}
          ...
          <View style={Styles.bottom}>
            ...
            <Button title=" Submit Task " onPress={() => onPressHandler()} />
          </View>
        </View>
      </View>
    </SafeAreaView>
