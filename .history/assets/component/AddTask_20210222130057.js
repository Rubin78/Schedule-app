        ...
        <View style={Styles.form}>
          <ScrollView>
            ...
            >
              ...
              >
                <View style={{ backgroundColor: "red",height:heightPercentageToDP(7.5),justifyContent:"flex-end" }}>
...
const Styles = StyleSheet.create({
  ...
  buttondate: { backgroundColor: "red",height:heightPercentageToDP(7.5),justifyContent:"flex-end" }
});
