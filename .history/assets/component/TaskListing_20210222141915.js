  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <View style={{ backgroundColor: "red", marginTop: 0, padding: 5 }}>
        <ScrollView>
          <View>
            <View style={{ flex: 1 ,width: widthPercentageToDP(25),flexDirection: "row-reverse"}}>
              <Button style={{ flex: 1 ,width: widthPercentageToDP(25),flexDirection: "row-reverse"}}
                title="Add Task"
